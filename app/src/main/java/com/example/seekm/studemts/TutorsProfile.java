...
public class TutorsProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(TutorsProfile.this, myUID,Toast.LENGTH_LONG).show();
...
//                mProfileStatus.setText(display_status);
                ...
                mFriendDatabase.child(user_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        mfriendReqReference.child(mFirebaseUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            @Override
                            public void onCancelled(DatabaseError databaseError) {
                                Toast.makeText(TutorsProfile.this, "Error fetching Friend request data", Toast.LENGTH_SHORT).show();
                            }
                        });
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TutorsProfile.this,NearbyTutorsMapActivity.class);
                    ...
                    mRootReference.updateChildren(requestMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError==null){
                                ...
                                Toast.makeText(TutorsProfile.this, "Friend Request sent successfully", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(TutorsProfile.this, "Some error in sending friend Request", Toast.LENGTH_SHORT).show();
                            }
                    ...
                    mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError == null){
                                ...
                                Toast.makeText(TutorsProfile.this, "Friend Request Cancelled Successfully...", Toast.LENGTH_SHORT).show();
                            }
                            else{

                                //m0ProfileSendReqButton.setEnabled(true);
                                Toast.makeText(TutorsProfile.this, "Cannot cancel friend request...", Toast.LENGTH_SHORT).show();
                    ...
                    mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError == null){
                                ...
                                request.setEnabled(true);
                                Toast.makeText(TutorsProfile.this, "Successfully Unfriended...", Toast.LENGTH_SHORT).show();
                            }
                            else{
                                request.setEnabled(true);
                                Toast.makeText(TutorsProfile.this, "Cannot Unfriend..Contact Kshitiz..", Toast.LENGTH_SHORT).show();
